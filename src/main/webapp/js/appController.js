	...
	function(ko, CoreRouter, ModuleRouterAdapter, KnockoutRouterAdapter, UrlParamAdapter, ThemeUtils, moduleUtils, ModuleAnimations, ArrayDataProvider, KnockoutTemplateUtils) {
		function ControllerViewModel() {
			...
			var navData = [
				...
				{ path: 'registrarUsuario', detail: { label: 'Registrar Usuarios' } },
				{ path: 'login', detail: { label: 'Login' } },
				...
				{ path: 'verCitasSanitario', detail: { label: 'Ver Citas Sanitario' } },
				{ path: 'verCitasOtrosDias', detail: { label: 'Ver Citas Otro Dia' } },
				{ path: 'changePassword', detail: { label: 'Cambiar Contrasena' } },
